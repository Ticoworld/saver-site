...
const Tokenomics = () => {
  ...
  return (
    <section id="tokenomics" className="py-20 bg-gradient-to-br from-saver-green/5 to-saver-green/10 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-64 h-64 bg-saver-green/10 rounded-full transform translate-x-1/3 translate-y-1/3"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            className="bg-saver-green text-white rounded-2xl shadow-xl p-8"
          >
            ...
            <ul className="space-y-4">
              {features.map((feature, index) => (
                ...
                >
                  <div className="bg-white rounded-full p-1 mt-1 mr-3">
